...
#+BEGIN_SRC bash
git clone https://github.com/salotz/orgacorn
cd Orgacorn
#+END_SRC
...
#+begin_src bash
pip install --index-url https://test.pypi.org/simple/ --no-deps Orgacorn-salotz
#+end_src
